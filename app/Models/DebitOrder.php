...
class DebitOrder extends Model
{
    ...
    {
        return $this->one(
            "SELECT d.*, l.loan_no, l.branch_id AS loan_branch_id, b.id_number, b.phone, b.borrower_no, b.loan_ref_no AS borrower_loan_ref_no, CONCAT(b.first_name,' ',b.last_name) AS borrower_name
             FROM debit_orders d
             JOIN loans l ON l.id = d.loan_id
             JOIN borrowers b ON b.id = d.borrower_id
             WHERE d.id = ?",
