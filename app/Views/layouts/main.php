          ...
          $menus = [
            ...
            'Collections' => ['icon' => 'mdi-bank', 'groups' => [
              '_flat' => ['items' => [
                ...
                ['label' => 'Pay-Cycle Policies', 'url' => url('/pay-cycle-policies'), 'perm' => 'pay_cycle_policies.manage'],
                ['label' => 'Public Holidays', 'url' => url('/public-holidays'), 'perm' => 'public_holidays.manage'],
                ['label' => 'Collection Date Adjustments', 'url' => url('/collection-date-adjustments'), 'perm' => 'collection_date_adjustments.view'],
